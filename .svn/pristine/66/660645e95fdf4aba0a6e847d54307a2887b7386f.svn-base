...
namespace HB.WebUI.Controllers
{
    public class HotelController : Controller
    {
        ...
        public ActionResult HotelPaymentVoucher(string clientRef, string reqid)
        {
            ...
            ApiModel.auto.messages.BookingRS bookingRs = new ApiModel.auto.messages.BookingRS();
                ...
                }))
            {
                ...
                // resp = client.PostAsync("http://67.222.132.248:9091/api/HotelBooking/ConfirmBooking/", contentToSend).Result;
                // staging URL
                 resp = client.PostAsync("http://localhost:8995/api/HotelBooking/ConfirmBooking/", contentToSend).Result;
                // Live URL
                // resp = client.PostAsync("http://hotels.tag2travel.com:4585/api/HotelBooking/ConfirmBooking/", contentToSend).Result;
                bookingRs = resp.Content.ReadAsAsync<ApiModel.auto.messages.BookingRS>().Result;
                Session.Clear();
            }
        ...
        private Redirect make_Redirect()
        {
            Redirect redirect = new Redirect();
             redirect.returnUrl = "http://localhost:51406/hotel/HotelPaymentVoucher";
           // redirect.returnUrl = "http://67.222.132.248:9091/hotel/HotelPaymentVoucher";
