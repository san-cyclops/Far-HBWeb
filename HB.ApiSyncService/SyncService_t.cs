...
namespace HB.ApiSyncService
{
    public class SyncService_t
    {
            ...
            try
            {
                ...
                using (var db = new HBEntities())
                {
                    ...
                    for (int i = 1; i <= 2000; i++)
                    {
                        ...
                        hotelsRs = hotelContentService.getHotels(hotelfrom, hotelto);
                        ...
                        foreach (var hotelList in hotelsRs.hotels)
                        {
                            ...
                            hotel.code = hotelList.code;
                            hotel.name = (hotelList.name == null) ? "" : hotelList.name.content;
                            hotel.description = (hotelList.description == null) ? "" : hotelList.description.content;
                            hotel.countryCode = hotelList.countryCode;
                            hotel.destinationCode = hotelList.destinationCode;
                            hotel.zoneCode = hotelList.zoneCode;
                            hotel.categoryCode = hotelList.categoryCode;
                            hotel.categoryGroupCode = hotelList.categoryGroupCode;
                            hotel.chainCode = hotelList.chainCode;
                            hotel.accommodationTypeCode = hotelList.accommodationTypeCode;
                            hotel.address = (hotelList.address == null) ? "" : hotelList.address.content;
                            hotel.postalCode = hotelList.postalCode;
                            hotel.city = (hotelList.city == null) ? "" : hotelList.city.content;
                            hotel.email = hotelList.email;
                            hotel.license = hotelList.license;
                            hotel.giataCode = hotelList.giataCode;
                            hotelReplist.Add(hotel);
                        ...
                        db.HotelReps.AddRange(hotelReplist);
                        db.SaveChanges();
        ...
        public string SyncHotelDetails(long from,long to)
        {
            try
            {
                ////destinations 
                ...
                List<HotelRep> hotelRepLst = new List<HotelRep>();
                ...
                using (var db = new HBEntities())
                {
                    ...
                    {
                        hotelRepLst = db.HotelReps.Where(a=>a.HotelRepID>=from && a.HotelRepID<to).ToList();
                        ...
                        foreach (var hotelList in hotelRepLst)
                        {

                            hotelsRs = new HotelsRS();

                            hotelsRs = hotelContentService.getHotelsfromCode(hotelList.code, hotelList.code);
                            ...
                            if (hotelsRs.hotels[hotelCount].coordinates != null)
                            {
                                ...
                                geoLocationRep.secondaryLongitude = hotelsRs.hotels[0].coordinates.secondaryLongitude;
                            ...
                            if (hotelsRs.hotels[hotelCount].facilities != null)
                            {
                                ...
                                foreach (var hotelfac in hotelsRs.hotels[hotelCount].facilities)
                                {
                                    ...
                                    hotelFacilityRep.description =  hotelfac.description !=null ? hotelfac.description : "";
                                    ...
                                    hotelFacilityRep.facilityName = hotelfac.facilityName != null ? hotelfac.facilityName : "";
                            ...
                            if (hotelsRs.hotels[hotelCount].rooms != null)
                            {
                                ...
                                foreach (var hotelRoom in hotelsRs.hotels[hotelCount].rooms)
                                {
                                    ...
                                    {
                                        List<HotelRoomFacilityRep> hotelRoomFacilityReplst = new List<HotelRoomFacilityRep>();

                                        foreach (var varlist in hotelsRs.hotels[hotelCount].rooms[roomCount].roomFacilities)
                                        {
                                    ...
                                    if (hotelsRs.hotels[hotelCount].rooms[roomCount].roomStays != null)
                                    {
                                        ...
                                        foreach (var varlist in hotelsRs.hotels[hotelCount].rooms[roomCount].roomStays)
                                        {
                            ...
                            if (hotelsRs.hotels[hotelCount].segments != null)
                            {
                                foreach (var hotelsegmentCodes in hotelsRs.hotels[hotelCount].segments)
                                {
                                    ...
                                    segmentRep.description = (hotelsegmentCodes.description == null) ? "" : hotelsegmentCodes.description.content;
        ...
        //public bool SyncRatecommentdetails()
        //{
        //    try
        //    {

        //        RateComments groupCategoriesRs = new GroupCategoriesRS();
        //        HotelContentService hotelContentService = new HotelContentService();
        //        //Enum count = {}
