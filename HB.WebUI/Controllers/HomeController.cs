...
namespace WebUI.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        //public ActionResult Booking(HotelSearch hotelSearch)
        {
            ...
            //Session["Markup"] = 3;//hardcoded value by isuru
            model.Markup = Convert.ToInt32(Session["Markup"]);
        ...
        public ActionResult HotelSearch()
        {
            try {
                ...
                {
                    Session.Clear();
                    return RedirectToAction("HotelSearchIframe", "Home");
                }
            }
        ...
        public ActionResult HotelPaymentVoucher(string clientRef, string reqid)
        {
            ...
            paymentCompleteRequest = new PaymentCompleteRequest();
            // paymentCompleteRequest.clientId = 14000914;
            paymentCompleteRequest.clientId = Convert.ToInt32(Session["ClientID"]);
            ...
            catch (GatewayClientException exp)
            {
                ...
                {
                    writer.WriteLine("Message :" + exp.Message + "<br/>" + Environment.NewLine + "StackTrace :" + exp.StackTrace +
                ...
                }))
            {
                ...
                // resp = client.PostAsync("http://localhost:51406/api/HotelBooking/ConfirmBooking/", contentToSend).Result;
                // staging URL
        ...
        public string Sendpayment(HotelPayment objData)
        {
            ...
            try
            {
                ...
                if (paymentInitResponse != null)
                {
                    ...
                    base.Session.Add("http://www.farholidays.com", paymentInitResponse.paymentPageUrl);
            ...
            {
                return "http://farholidays.com/error/";
        ...
        private Redirect make_Redirect()
        {
            ...
            redirect.returnUrl = "http://67.222.132.248:9090/home/HotelPaymentVoucher";
            // redirect.returnUrl = "http://hotels.tag2travel.com/home/HotelPaymentVoucher";
        ...
        [Route("home/CheckAuth")]
        [HttpPost]
        public JsonResult CheckAuth(AgentUserLogin model)
        {
            var db = new HBNEWEntities();
            try
            {
                var logindata = db.AgentLogins.Where(x => x.Email == model.Email && x.Password == model.password).FirstOrDefault();
                if (logindata != null)
                {
                     Session["LoginUser"] = logindata;
                    return Json("1");
                }
                else
                {
        ...
        //public ActionResult Addsession(int markup)
        //{
        //    var model = new HotelBooking();
        //    model.Markup = markup;
        //    return View(model);
        ...
        [Route("home/Addsession")]
        [HttpPost]
        public string Addsession(string markup)
        {
